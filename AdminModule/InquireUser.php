...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onLoad="date1()" oncontextmenu="return false;">
		<div class="container1">
			...
			<div class="display2">
				<div class="display5">
					<button style="background-color:#FF4500" type="button" onclick="add_user()">Add User</button>
					<h4 style="color: green">
						This option enables you to add new customer to the Database
					</h4>
				</div>
				<div class="display5">
					<form name="View_Users" method="post" action="SearchUsers.php">
					<input style="background-color:#FF4500" type="submit" value="View User" name="view" >
					<h4 style="color: green">
						This option enables you to view/update/delete  existing customers from the Database
					</h4>
					</form>
				</div>
				<div  id="date1">

...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		*/
		function view_staff(){
			window.location.href="SearchStaffs.php";
		}	
		</script>
	...
	<body onLoad="date1()" oncontextmenu="return false;">
		<div class="container1">
			...
			<div class="display2">
				<div class="display5">
					<button style="background-color:#FF4500" type="button" onclick="add_staff()">Add Staff</button>
					<h4 style="color: green">
						This option enables you to add new customer to the Database
					</h4>
				</div>
				<div class="display5">
					<button style="background-color:#FF4500" type="button" onclick="view_staff()">View Staff</button>
					<h4 style="color: green">
						This option enables you to add new customer to the Database
					</h4>
				</div>
